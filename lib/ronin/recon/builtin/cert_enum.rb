...
module Ronin
  module Recon
    ...
    class CertEnum < Worker
      ...
      description <<~DESC
        Enumerates over the subject CommonName and subjectAltNames of a SSL/TLS
        certificate.
      DESC
      ...
      #
      # @yield [host]
      #   All host names, wildcard host names, or IP addresses, from the SSL/TLS
      #   certificate will be yielded.
      #
